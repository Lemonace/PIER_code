...
TRAIN_MODE = 3
MODEL_NAME = "dcn_pointwise_model_v3"
# poi类别特征
...
if DATA_MODE == 1:
    # TRAIN_FILE = ['/users/meituan_sxw/Downloads/part-r-00047']
    TRAIN_FILE = ['/users/lemonace/Downloads/docker_data/part-r-00018']
    ...
    TRAIN_FILE = [
        "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-waimaiad/yangfan129/train_data/avito_v3_new_point_wise/train_data/part-r-*"]
    VALID_FILE = [
        "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-waimaiad/yangfan129/train_data/avito_v3_new_point_wise/test_data/part-r-*"]
    TEST_FILE = [
        "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-waimaiad/yangfan129/train_data/avito_v3_new_point_wise/test_data/part-r-*"]
elif DATA_MODE == 4:
